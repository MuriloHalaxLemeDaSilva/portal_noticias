...
<p>
          ...
          <b>Publicado por </b> <?php echo htmlentities($row['postedBy']);?> em </b><?php echo htmlentities($row['postingdate']);?> |
          <?php if($row['lastUpdatedBy']!=''):?>
          <b>Última Atualização por </b> <?php echo htmlentities($row['lastUpdatedBy']);?> em </b><?php echo htmlentities($row['UpdationDate']);?></p>
        <?php endif;?>
                <p><strong>Compartilhar:</strong> <a href="http://www.facebook.com/share.php?u=<?php echo $currenturl;?>" target="_blank">Facebook</a> | 
...
<a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $currenturl;?>" target="_blank">Linkedin</a>  <b>Visitas:</b> <?php print $visits; ?>
                </p>
                <hr />
...
<input type="text" name="name" class="form-control" placeholder="Digite seu nome completo" required>
 ...
 <div class="form-group">
 <input type="email" name="email" class="form-control" placeholder="Digite seu e-mail válido" required>
 </div>
