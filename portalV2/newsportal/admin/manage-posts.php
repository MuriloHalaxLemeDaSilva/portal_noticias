...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Portal de Notícias | Gerenciar Publicações</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Gerenciar Publicações </h4>
...
<td colspan="4" align="center"><h3 style="color:red">Nenhum registro encontrado</h3></td>
<tr>
<?php 
} else {
...
<td><a href="edit-post.php?pid=<?php echo htmlentities($row['postid']);?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a> 
    &nbsp;<a href="manage-posts.php?pid=<?php echo htmlentities($row['postid']);?>&&action=del" onclick="return confirm('Você realmente deseja excluir?')"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
 </tr>
<?php } }?>
