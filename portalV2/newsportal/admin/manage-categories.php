...
if($_GET['action']=='parmdel' && $_GET['rid'])
{
	...
	$delmsg="Categoria excluída forever";
}
...
<strong>Ops!</strong> <?php echo htmlentities($delmsg);?></div>
<?php } ?>
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Categorias Excluídas</h4>
...
<td><?php echo htmlentities($row['PostingDate']);?></td>
<td><?php echo htmlentities($row['UpdationDate']);?></td>
<td><a href="manage-categories.php?resid=<?php echo htmlentities($row['id']);?>"><i class="ion-arrow-return-right" title="Restaurar esta categoria"></i></a> 
	&nbsp;<a href="manage-categories.php?rid=<?php echo htmlentities($row['id']);?>&&action=parmdel" title="Excluir permanentemente"> <i class="fa fa-trash-o" style="color: #f05050"></i> </td>
</tr>
<?php
$cnt++;
 } ?>
