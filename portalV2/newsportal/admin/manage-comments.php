...
if($_GET['action']=='del' && $_GET['rid'])
{
	...
	$delmsg="Comentário excluído permanentemente";
}
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Gerenciar Comentários Aprovados</h4>
