...
<html lang="en">
    <head>
        ...
        <title>Portal de Notícias | Alterar Senha</title>
...
{
alert("Nova Senha Filed is Empty !!");
document.chngpwd.newpassword.focus();
return false;
}
else if(document.chngpwd.confirmpassword.value=="")
{
alert("Confirmar Senha Filed is Empty !!");
document.chngpwd.confirmpassword.focus();
return false;
}
else if(document.chngpwd.newpassword.value!= document.chngpwd.confirmpassword.value)
{
alert("Password and Confirmar Senha Field do not match  !!");
document.chngpwd.confirmpassword.focus();
return false;
}
return true;
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Alterar Senha </b></h4>
                                    <hr />
